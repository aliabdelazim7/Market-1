...
export const stickerArtDirections: StickerArtDirection[] = [
  ...
  { id: 'sky-hero', name: 'بطل السماء', motif: 'طيران وبرق', icon: '⚡', palette: ['#2563eb', '#facc15'], prompt: 'original flying child superhero, blue and gold, geometric lightning emblem, clean horizontal school card' },
  { id: 'web-hero', name: 'بطل الشبكة', motif: 'روبوت وشبكات', icon: '✦', palette: ['#14b8a6', '#f97316'], prompt: 'original robotic web guardian mascot, teal and orange, futuristic city, clean horizontal school card' },
  { id: 'shadow-hero', name: 'حارس الظلال', motif: 'قمر ومدينة', icon: '◐', palette: ['#312e81', '#a78bfa'], prompt: 'original night guardian superhero, charcoal and electric purple, moon and city, clean horizontal school card' },
