-- DEBUGGED CONSOLIDATED DATABASE SCRIPT
...
-- ---------------------------------------------------------------------------
create or replace function public.get_attendance_status(p_employee_id text)
returns jsonb
language sql
security definer
set search_path = public
...
revoke all on function public.get_attendance_status(text) from public;
grant execute on function public.get_attendance_status(text) to anon, authenticated;
...
revoke all on function public.record_attendance(text, text, text) from public;
grant execute on function public.record_attendance(text, text, text) to anon, authenticated;
